...
function ProductDetails(props) {
  return (
    ...
    >
      {data.map((el, i) => {
        return (
          <Box className="product_detail_main" key={i + 1}>
            <Box className="product_detail_image">
              <Img src={el.image} />
            </Box>
            <Box className="product_detail_child">
              <Text className="product_detail_headers">{el.title}</Text>
              <Text className="product_detail_descripton">{el.description}</Text>
              <Text className="product_detail_purchese">{el.product}</Text>
            </Box>
          </Box>
        );
      })}
